...
def parse_lkh_tour(filename):
    """Reads the tour file generated by LKH and returns the solution as a list of nodes"""
...
def lkh_tsp(instance, lkh_path="scripts/LKH-3.0.13/LKH"):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output", type=str, default="scripts/data/MIXED10/MIXED10_TRAIN1M.json")
